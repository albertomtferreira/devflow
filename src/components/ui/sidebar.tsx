  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'group peer hidden shrink-0 md:block text-sidebar-foreground',
          className
        )}
        data-state={state}
      ...
      >
        <div
          className={cn(
            'duration-200 h-screen w-[--sidebar-width] flex flex-col bg-sidebar transition-[width] ease-linear',
